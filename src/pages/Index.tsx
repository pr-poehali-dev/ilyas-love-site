      ...
      <div className="relative z-10">
        ...
        <section className="px-4 py-20 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="font-heading text-6xl md:text-8xl font-bold bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text text-transparent mb-8 animate-heart-beat">
              Ильясу 💖
            </h1>
              ...
              <CardContent className="p-8 md:p-12">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="relative">
                    <img
                      src="/img/2f736d2d-4dea-47bb-b771-dfe43fb49452.jpg"
                      alt="Красивые карие глаза"
                      className="rounded-2xl shadow-lg w-full h-80 object-cover animate-float"
                    />
                  </div>
                </div>
              </CardContent>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <Card
                  key={index}
                  className="bg-white/70 backdrop-blur-sm hover:scale-105 transition-transform duration-300 border-pink-100"
                >
            ...
            <Card className="bg-gradient-to-r from-pink-100 to-purple-100 border-pink-200 shadow-xl">
              <CardContent className="p-8 md:p-12">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="relative">
                    <img
                      src="/img/c36ee266-8dbf-4024-a6d5-685d79312b77.jpg"
                      alt="Hello Kitty и милые котики"
                      className="rounded-2xl shadow-lg w-full h-80 object-cover animate-float"
                    />
                  </div>
                  <div>
          ...
          <div className="max-w-3xl mx-auto">
            <Card className="bg-gradient-to-r from-pink-500 to-blue-500 text-white shadow-2xl">
              <CardContent className="p-8 md:p-12">
                ...
                <Button
                  className="bg-white text-pink-500 hover:bg-pink-50 font-medium px-8 py-3 text-lg animate-heart-beat"
                  size="lg"
                >
